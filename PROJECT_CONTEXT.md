...
> Dernière mise à jour : 2026-09-21 (« Annuler » une suppression restaure la position et les valeurs d'origine ; audit UI complet de l'écran principal : centrage, champs de date, icônes de barre d'état, mise en page en police agrandie ; action de tri masquée quand aucune candidature n'existe ; icône d'état vide = boîte/plateau vide sur les deux plateformes ; règle permanente « Process de documentation » ajoutée en §0 ; écran « À propos » : données, droits, « Supprimer toutes mes données » en double confirmation, contact par e-mail ; Android en Material 3 Expressive ; icône d'état vide Android).
